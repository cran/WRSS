createReservoir.default <-
           ...
           latlon=NULL)
  {
    ...
    resault<-list()
    operation<-createReservoir.base (type,name,priority,downstream,netEvaporation,seepageFraction,seepageObject,geometry,plant,penstock,initialStorage,latlon)
